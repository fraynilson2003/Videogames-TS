...
export function DetailLoading() {
  return (
    <div className="flex justify-center items-center mx-5 mt-5  text-blanco border h-[200px] min-h-[200px] max-w-[350px] min-w-[350px] overflow-hidden rounded-sm
    md:min-w-[550px] md:min-h-[350px] md:max-w-[550px] md:max-h-[350px] md:mx-0 ">
